...
return array (
  ...
  'The format of {attribute} is invalid.' => 'Formát pole {attribute} není platný.',
  ...
  '{attribute} "{value}" has already been taken.' => 'Hodnota "{value}" z pole {attribute} je již použitá.',
  '{attribute} "{value}" is invalid.' => 'Hodnota "{value}" z pole {attribute} je neplatná.',
  '{attribute} cannot accept more than {limit} files.' => 'Pole {attribute} nemůže akceptovat více než {limit} souborů.',
  '{attribute} cannot be blank.' => 'Pole {attribute} nesmí být prázdné.',
  '{attribute} is invalid.' => 'Hodnota {attribute} je neplatná.',
  '{attribute} is not a valid URL.' => 'Hodnota {attribute} není správný URL odkaz.',
  '{attribute} is not a valid email address.' => 'Hodnota {attribute} není platná emailová adresa.',
  '{attribute} is not in the list.' => 'Hodnota {attribute} není v seznamu.',
  '{attribute} is of the wrong length (should be {length} characters).' => 'Hodnota {attribute} nemá správnou délku (měla by mít {length} znaků)',
  '{attribute} is too big (maximum is {max}).' => 'Hodnota {attribute} je příliš velká (maximum je {max}).',
  '{attribute} is too long (maximum is {max} characters).' => 'Hodnota {attribute} je příliš dlouhá (maximum je {max} znaků).',
  '{attribute} is too short (minimum is {min} characters).' => 'Hodnota {attribute} je příliš krátká (minimum je {min} znaků).',
  '{attribute} is too small (minimum is {min}).' => 'Hodnota {attribute} je příliš malá (minimum je {min}).',
  '{attribute} must be a number.' => 'Hodnota {attribute} musí být číslo.',
  '{attribute} must be an integer.' => 'Hodnota {attribute} musí být celočíselná.',
  '{attribute} must be either {true} or {false}.' => 'Hodnota {attribute} musí být {true} nebo {false}.',
  '{attribute} must be greater than "{compareValue}".' => 'Hodnota {attribute} musí být větší než hodnota {compareValue}.',
  '{attribute} must be greater than or equal to "{compareValue}".' => 'Hodnota {attribute} musí být větší nebo rovna hodnotě {compareValue}.',
  '{attribute} must be less than "{compareValue}".' => 'Hodnota {attribute} musí být menší než hodnota {compareValue}.',
  '{attribute} must be less than or equal to "{compareValue}".' => 'Hodnota {attribute} musí být menší nebo rovna hodnotě {compareValue}.',
  '{attribute} must be repeated exactly.' => 'Hodnota {attribute} musí být přesně zopakovaná.',
  '{attribute} must be {type}.' => 'Hodnota {attribute} musí být typu {type}.',
  '{attribute} must be {value}.' => 'Pole {attribute} musí mít hodnotu {value}.',
  '{attribute} must not be equal to "{compareValue}".' => 'Hodnota {attribute} musí být rovna "{compareValue}".',
