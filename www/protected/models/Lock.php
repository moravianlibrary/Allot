...
class Lock extends ActiveRecord
{
	...
	public function relations()
	{
		return array(
			...
			'keys' => array(self::MANY_MANY, 'Key', '{{key_lock}}(lock_id, key_id)'),
			'doors' => array(self::MANY_MANY, 'Door', '{{door_lock}}(lock_id, door_id)'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'keys' => Yii::t('app', 'Keys, that the lock can be opened with'), 'Klíče, kterými lze zámkovou vložku odemknout',
			'doors' => Yii::t('app', 'Lock in door'),
		);
	}
